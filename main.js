alert(
  "Bienvenido, dejanos ayudarte con el calculo de interes monetario, por favor selecciona a continuacion el tipo de interes"
);
...
if (interes === null || interes === "") {
  //Recomiendo usar "==="
  alert("Lamentamos te vayas, buen dia"); //Esto me imagino que era un alert jajajja
} else {
  if (interes === 1) {
    //"==="
    //interes fijo
    ...
    alert("Al final del periodo deberas cancelar " + total); //Espacio para que se lea mejor!
  }
  if (interes === 2) {
    //"==="
    valor_prestamo = parseInt(prompt("Valor del prestamo"));
    ...
    alert("Al final del periodo deberas cancelar " + total); //Espacio
  }
  if (interes === 3) {
    //"==="
    valor_prestamo = parseInt(prompt("Valor del prestamo"));
    ...
    total =
      valor_prestamo * Math.pow(1 + interes_fijo / 100 / cuotas, 120) -
      valor_prestamo;
    alert("Al final del periodo deberas pagar en intereses " + total); //Espacio
  }
}
